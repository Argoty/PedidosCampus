...
##############################################################################
# view-erds.sh
# Levanta un live-server local para cada uno de los 6 ERD diagrams
...
#   - Levanta 6 servidores en puertos diferentes (3000-3005)
...
echo -e "  5. ${CYAN}calificaciones-liam-erd${NC}    → ${CYAN}http://localhost:3005${NC}"
echo ""
...
if command -v xdg-open &>/dev/null; then
  ...
  sleep 1
  xdg-open http://localhost:3005 >/dev/null 2>&1 || true
